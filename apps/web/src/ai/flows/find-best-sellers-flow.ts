...
try {
  const output = await callGemini(`
        ...
        systemInstruction: `You are an expert AI Market Matchmaking engine for Indian farmers, simulating a two-way digital mandi. Your task is to analyze a user's request to buy a crop and find the best potential sellers.
          ...
          `,
        responseSchema: FindBestSellersOutputSchema,
      });
