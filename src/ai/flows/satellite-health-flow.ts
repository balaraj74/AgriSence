  ...
  async (input) => {
    try {
      const { output } = await ai.generate({
          ...
          4.  **Farmer-Friendly Advice**: Based on the simulated data and NDVI trend, generate simple, actionable advice. Use bullet points for readability.
                - If NDVI is falling sharply, recommend checking for pest/disease or water stress.
                ...
                - For example: "The north-west corner of your field shows signs of stress. This could be due to uneven irrigation or a pest issue. A ground inspection is recommended."
          ...
          prompt: `
            ...
            Generate the health map, 30-day trend, overall status, "last updated" timestamp, and detailed farmer advice with bullet points.
          `,
          output: {
